...
class Exercise(models.Model):
    ...
    RULE_CHOICES=( ("A", "Ampere"), ("V", "Volt"), ("W", "Watt") )

    id          = models.AutoField(primary_key=True, verbose_name="id")
    teacher_id  = models.ForeignKey(Account, null=True, on_delete=models.SET_NULL, limit_choices_to={'role': 2}, verbose_name="teacher id")
    theme_id    = models.ManyToManyField(Theme, verbose_name="theme id")
    question    = models.CharField(max_length=500, verbose_name="question")
    img_path    = models.CharField(max_length=100, null=True, blank=True, verbose_name="image path")
