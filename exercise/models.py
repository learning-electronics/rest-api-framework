...
class Exercise(models.Model):
    ...
    teacher     = models.ForeignKey(Account, null=True, on_delete=models.SET_NULL, limit_choices_to={'role': 2}, verbose_name="teacher")
    theme       = models.ManyToManyField(Theme, verbose_name="theme")
    ...
    ans1        = models.CharField(max_length=250, verbose_name="answer 1")
    ans2        = models.CharField(max_length=250, verbose_name="answer 2")
    ans3        = models.CharField(max_length=250, verbose_name="answer 3")
    correct     = models.CharField(max_length=250, verbose_name="correct answer")
